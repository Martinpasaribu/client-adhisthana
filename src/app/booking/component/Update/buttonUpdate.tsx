...
const ButtonUpdate = ( { checkin, checkout, OpenCalendarMini, OpenModalPeople, pushUpdate, peopleMax,updateCheckIn, updateCheckOut} : ButtonProps ) => {
  ...
  const handleOpenDiscount = () => {
    ...
    return (
    <section className='w-full flex-center flex-col md2:flex-row gap-4 md2:gap-1 mt-4 px-[.8rem] xl:px-[1.5rem]'>
          
        <div className='flex h-full w-full justify-around items-center text-[10px] hp4:text-[14px]  md1:text-[16px] gap-2 md1:gap-5 m-1 p-3 border-[1px] shadow-md rounded-xl'>
