...
app.use(cors({
    origin: ["http://localhost:3000","http://localhost:3001","https://adhistahan.vercel.app","https://adhisthanavillas.com"],
...
app.use(session({
    ...
    cookie: {
        ...
        domain: '.adhisthanavillas.com', // Agar bisa digunakan di main domain & subdomain
        path: '/'
    }
}));
